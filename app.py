...
def predict():
    ...
    if request.method == 'POST':
        ...
        if batting_team == "None" or bowling_team == "None" or  runs is None or overs is None or wickets is None or runs_in_prev_5 is None or wickets_in_prev_5 is None:
        ...
        if batting_team == bowling_team or overs < 5 or overs > 20 or (overs * 10) % 10 >= 6 or wickets > 20 or runs < runs_in_prev_5 or wickets < wickets_in_prev_5:
            return render_template('result1.html')
        if overs==5 and runs!=runs_in_prev_5:
            return render_template('result1.html')
        ...
        if overs == 20 or overs == 5 or wickets==10:
            my_prediction = runs
